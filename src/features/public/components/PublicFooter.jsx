...
const PublicFooter = () => {
  return (
    <Container className={'mt-auto'}>
       <footer className="p-4 mt-auto bg-neutral-50 sm:p-6 ">
      <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-semibold text-green-900 dark:text-white">
              SkinSync
            </h2>
            <p className="mt-2 text-gray-600 ">
              Easily check if two skincare products are compatible with each other. Make smarter, safer skincare decisions for your unique routine.
            </p>
          </div>
        </div>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-green-700 sm:text-center ">
            © 2025 <a href="#" className="hover:underline">SkinSync™</a>. All Rights Reserved.
          </span>

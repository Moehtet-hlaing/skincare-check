...
{isLoading ? <div>Loading...</div>: <>
    ...
    <div className="flex flex-col gap-2">
      ...
      >
        ...
        {!isLoading &&
          data &&
          data.map((product) => (
            <option key={product.id} value={JSON.stringify(product)} className="font-bold">
  ...
  <div className="flex justify-center mt-8">
    <button
      type="submit"
      form="check-form"
      className="w-1/2 md:w-1/3 px-4 py-1.5 border-neutral-700 border text-neutral-700 font-semibold text-center rounded-full hover:border-neutral-800 focus:ring-4 focus:ring-neutral-300"
    >

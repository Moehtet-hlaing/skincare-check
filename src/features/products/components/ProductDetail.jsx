  ...
  <div className="container mx-auto px-4 py-8 max-w-5xl">
    <div className="bg-white rounded-2xl shadow-md overflow-hidden p-6 md:p-10">
      <div className="flex flex-col md:flex-row md:items-center gap-10">
        ...
        {/* Image Section */}
        <div className="w-1/2 md:w-1/4 md:h-1/4  bg-gray-100 rounded-xl flex items-center justify-center p-4 shadow-sm">
          <img
        ...
        <div className="md:w-1/2 flex flex-col gap-4">
          <div>
            <h1 className=" relative text-3xl font-extrabold text-gray-900 leading-tight">{currentProduct.product_name}</h1>
            ...
            <p className="text-lg text-gray-600 mt-1"><i>{currentProduct.category}</i></p>
          </div>
          ...
          {currentProduct.ingredients?.length > 0 && (
            <div>
              <details className="group bg-gray-50 rounded-lg p-4 transition-all">
                <summary className="flex items-center justify-between cursor-pointer text-sm font-semibold text-gray-800">
                ...
                <p className="mt-3 text-gray-600 text-sm leading-loose">
